    ...
    <div class="mini-fit" id="div_two">
    	<%--
         ...
         if(null != grid1){
        	 ...
        	 if(sign.equals("hunan")){
					//String a = user.get("name");
					/* else if(username.equals("sjcbr2")){
						paramMap.put("casetype", "1");
					} */
					//alert(username);
					
					if("sjcbr".equals(username)){
						urlSb.append("&casetype=").append("1");
					}
					else if("sjcbr2".equals(username)){
						urlSb.append("&casetype=").append("2");
					} 
				}
        	 url = urlSb.toString();
